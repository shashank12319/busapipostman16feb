...
//	    }
	 ...
	 public TravelSchedule createSchedule(@RequestBody TravelScheduleDTO travelScheduleDTO)
	 {
	   ...
	   travelschedule.setDestination(null);
	   travelschedule.setEstimatedArrivalTime(null);
	   travelschedule.setEstimatedDepartureTime(null);
      travelschedule.setFareAmount(null);
      travelschedule.getSource();
